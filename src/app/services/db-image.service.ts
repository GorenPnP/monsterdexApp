...
export class DbImageService {
   ...
   * @param databaseService              - to get the actual db
   * @param messageService                - to inform the user about successes, alerts, errors
   */
   ...
   * @async
   * @param imageId - the id to find according image entry
   ...
   * @async
   * @param monsterId    - the id of a monster to find images for
